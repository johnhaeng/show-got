...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <NavBar user={this.state.user} userInput={this.state.userInput} logOut={this.logOut}/>
        ...
        <Route exact path="/designers/:cities" render={() => <Designer user={this.state.user}
          selectedCity={this.state.selectedCity}
          reset={this.resetSelectedCity}
          schedules={this.state.schedules} />}
        />
        <Route exact path="/designers" render={() => <Designer user={this.state.user}
          selectedCity={{}}
